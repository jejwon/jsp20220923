...
public class Servlet33 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//sql 실행
		//result set 처리
		String productName = ProductDao.getProductNameById(id, getServletContext()); //data access object
		
		//4.add attribute(결과)
		request.setAttribute("name", productName);
		//5.forward/redirect
		String path = "/WEB-INF/view/ch14/14.jsp";
